...
import { cartItemQuantity } from "../features/cartSlice";

import { foodItems } from "../constants/URLs";
import { MoonLoader } from "react-spinners";

const CartAddedItem = (props) => {
  const { item_id, quantity } = props.item;
  ...
  return (
    <div className="cart_added_item" key={props.key}>
        ...
        <div className="cart_item_info">
            <div className="cart_item_top">
                ...
                <div className="cart_item_count">
                    <div className="item_count_minus" onClick={() => handleMinusQuantity(item_id, quantity)}>
                    ...
                    <span>{quantity}</span>
                    <div className="item_count_plus" onClick={() => handlePlusQuantity(item_id, quantity)}>
